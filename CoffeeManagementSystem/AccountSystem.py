...
class AccountPage:
    def __init__(self, AccountSystem_window):
        ...
        # window Icon
        icon = PhotoImage(file='images\\Coffee_sm.png')
        ...
        # ====== LOGO ==========
        logoIcon = Image.open('images\\Coffee_sm.png')
        photo = ImageTk.PhotoImage(logoIcon)
        logo = Label(landing_page, image=photo, bg='#ffffff')
        logo.image = photo
        logo.place(x=20, y=45)

        brand_name = Label(landing_page, text='RR COFFEE SHOP', bg='#ffffff', fg='#ff6c38', font=("yu gothic ui", 15, "bold"))
        ...
        brand_name = Label(sign_in, text='RR COFFEE SHOP', bg='#ffffff', fg='#ff6c38', font=("", 15, "bold"))
        ...
        brand_name = Label(sign_up, text='RR COFFEE SHOP', bg='#ffffff', fg='#ff6c38', font=("", 15, "bold"))
        brand_name.place(x=90, y=60)
