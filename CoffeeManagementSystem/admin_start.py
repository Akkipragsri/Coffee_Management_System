...
class FirstPage:
    def __init__(self, dashboard_window):
        ...
        brandIcon = Image.open('images\\Coffee_sm.png')
        ...
        heading = Label(homepage, text='© RR COFFEE SH0P', bg='black', fg='#ff6c38', font=("yu gothic ui", 19, "bold"))
        ...
        def help():
            ...
            # Coffee Image
            bgImage = Image.open('images\\help1.png')
